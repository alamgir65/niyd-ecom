            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="slider_area owl-carousel">
                        <div class="single_slider" data-bgimg="{{asset('/')}}website/img/slider/slider1.jpg">
                        ...
                        <div class="single_slider d-flex align-items-center" data-bgimg="{{asset('/')}}website/img/slider/slider2.jpg">
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="deals_product_list">
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product1.jpg" alt=""></a>
                                            ...
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product2.jpg" alt=""></a>
                                                    <div class="label_product">
                                                        <span class="label_sale">sale</span>
                                                    </div>
                                                    <div class="quick_button">
                                    ...
                                    <div class="tab-pane fade" id="laptop" role="tabpanel">
                                        <div class="deals_product_list">
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product3.jpg" alt=""></a>
                                                    <div class="quick_button">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                                    </div>
                                                    <div class="product_timing">
                                            ...
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product4.jpg" alt=""></a>
                                                    <div class="label_product">
                                                        <span class="label_sale">sale</span>
                                                    </div>
                                                    <div class="quick_button">
                                    ...
                                    <div class="tab-pane fade" id="mobile" role="tabpanel">
                                        <div class="deals_product_list">
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product010.jpg" alt=""></a>
                                                    <div class="label_product">
                                                        <span class="label_sale">sale</span>
                                                    </div>
                                                    <div class="quick_button">
                                            ...
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product011.jpg" alt=""></a>
                                                    <div class="quick_button">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                                    </div>
                                                    <div class="product_timing">
                                    ...
                                    <div class="tab-pane fade" id="Fridge" role="tabpanel">
                                        <div class="deals_product_list">
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product5.jpg" alt=""></a>
                                                    <div class="quick_button">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                                    </div>
                                                    <div class="product_timing">
                                            ...
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product6.jpg" alt=""></a>
                                                    <div class="label_product">
                                                        <span class="label_sale">sale</span>
                                                    </div>
                                                    <div class="quick_button">
                                    ...
                                    <div class="tab-pane fade" id="Camera" role="tabpanel">
                                        <div class="deals_product_list">
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product08.jpg" alt=""></a>
                                                    <div class="label_product">
                                                        <span class="label_sale">sale</span>
                                                    </div>
                                                    <div class="quick_button">
                                            ...
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product09.jpg" alt=""></a>
                                                    <div class="quick_button">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                                    </div>
                                                    <div class="product_timing">
                                    ...
                                    <div class="tab-pane fade" id="tv" role="tabpanel">
                                        <div class="deals_product_list">
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product012.jpg" alt=""></a>
                                                    <div class="label_product">
                                                        <span class="label_sale">sale</span>
                                                    </div>
                                                    <div class="quick_button">
                                    ...
                                    <div class="tab-pane fade" id="speaker" role="tabpanel">
                                        <div class="deals_product_list">
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product013.jpg" alt=""></a>
                                                    <div class="label_product">
                                                        <span class="label_sale">sale</span>
                                                    </div>
                                                    <div class="quick_button">
                                            ...
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product014.jpg" alt=""></a>
                                                    <div class="quick_button">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                                    </div>
                                                    <div class="product_timing">
                                    ...
                                    <div class="tab-pane fade" id="Toys" role="tabpanel">
                                        <div class="deals_product_list">
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product7.jpg" alt=""></a>
                                                    <div class="quick_button">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                                    </div>
                                                    <div class="product_timing">
                                            ...
                                            <div class="single_deals_product">
                                                <div class="product_thumb">
                                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product8.jpg" alt=""></a>
                                                    <div class="label_product">
                                                        <span class="label_sale">sale</span>
                                                    </div>
                                                    <div class="quick_button">
                    ...
                    <div class="small_product_area">
                        ...
                        <div class="small_product_wrapper">
                            <div class="small_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/s-product/product3.jpg" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                            ...
                            <div class="small_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/s-product/product4.jpg" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                            ...
                            <div class="small_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/s-product/product5.jpg" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                            ...
                            <div class="small_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/s-product/product6.jpg" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                            ...
                            <div class="small_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/s-product/product7.jpg" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                            ...
                            <div class="small_product_items">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/s-product/product8.jpg" alt=""></a>
                                </div>
                                <div class="product_content">
                                    <div class="product_name">
                        ...
                        <div class="sidebar_banner_thumb mt-30">
                            <a href="shop.html"><img src="{{asset('/')}}website/img/bg/banner1.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-12">
                        <div class="single_product_left_sidebar">
                            <div class="single_product">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product9.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">sale</span>
                                    </div>
                                    <div class="quick_button">
                            ...
                            <div class="single_product">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product10.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">sale</span>
                                    </div>
                                    <div class="quick_button">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="single_product product_center">
                            <div class="product_thumb">
                                <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product11.jpg" alt=""></a>
                                <div class="quick_button">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-12">
                        <div class="single_product_right_sidebar">
                            <div class="single_product">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product12.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">sale</span>
                                    </div>
                                    <div class="quick_button">
                            ...
                            <div class="single_product">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product13.jpg" alt=""></a>
                                    <div class="quick_button">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{asset('/')}}website/img/bg/banner2.jpg" alt=""></a>
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{asset('/')}}website/img/bg/banner3.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="desktop1" role="tabpanel">
                            <div class="product_carousel product_column4 owl-carousel">
                                ...
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product22.jpg" alt=""></a>
                                        <div class="label_product">
                                            <span class="label_sale">sale</span>
                                        </div>
                                        <div class="quick_button">
                                ...
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product23.jpg" alt=""></a>
                                        <div class="quick_button">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal_box"  title="quick view"> <i class="zmdi zmdi-eye"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product24.jpg" alt=""></a>
                                        <div class="label_product">
                                            <span class="label_sale">sale</span>
                                        </div>
                                        <div class="quick_button">
                        ...
                        <div class="tab-pane fade" id="Camera1" role="tabpanel">
                            <div class="product_carousel product_column4 owl-carousel">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product25.jpg" alt=""></a>
                                        <div class="label_product">
                                            <span class="label_sale">sale</span>
                                        </div>
                                        <div class="quick_button">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{asset('/')}}website/img/bg/banner4.jpg" alt=""></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{asset('/')}}website/img/bg/banner5.jpg" alt=""></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{asset('/')}}website/img/bg/banner6.jpg" alt=""></a>
                        </div>
