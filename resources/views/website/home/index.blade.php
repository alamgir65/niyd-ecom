                        ...
                        <div class="categories_menu_toggle">
                            <ul>
                                ...
                                <li class="menu_item_children categorie_list">
                                    <a href="{{route('product-category',['id' => $category->id])}}"><span><i class="zmdi zmdi-desktop-mac"></i></span>
                                                        ...
                                                        <div class="product_content">
                                                            ...
                                                            <div class="action_links">
                                                                <ul>
                                                                    ...
                                                                    <li class="add_to_cart"><a href="{{route('cart.direct-add-to-cart',['id'=>$product->id])}}" title="add to cart"><i class="zmdi zmdi-shopping-cart-plus"></i> add to cart</a></li>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="single_product product_center">
                            ...
                            <div class="product_content">
                                ...
                                <div class="price_box">
                                    <span class="current_price">{{$new_product_mid->selling_price}}</span>
                                    <span class="old_price">{{$new_product_mid->regular_price}}</span>
                                </div>
                                <div class="action_links">
                                    <ul>
                                        <li class="wishlist"><a href="wishlist.html" title="Add to Wishlist"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
                            ...
                            <div class="product_carousel product_column4 owl-carousel">
                                ...
                                <div class="single_product">
                                    ...
                                    <div class="product_content">
                                        ...
                                        <div class="price_box">
                                            <span class="current_price">{{$home_category_one_product->selling_price}}</span>
                                            <span class="old_price">{{$home_category_one_product->regular_price}}</span>
                                        </div>
                                        <div class="action_links">
                                            <ul>
                                                <li class="wishlist"><a href="wishlist.html" title="Add to Wishlist"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="Camera2" role="tabpanel">
                            <div class="product_carousel product_column4 owl-carousel">
                                ...
                                <div class="single_product">
                                    <div class="product_thumb">
                                        <a href="{{route('product-details',['id'=>$home_category_two_product->id])}}"><img src="{{asset($home_category_two_product->image)}}" alt=""></a>
                                        <div class="label_product">
                                            <span class="label_sale">sale</span>
                                        </div>
                                        <div class="quick_button">
                                    ...
                                    <div class="product_content">
                                        <div class="product_name">
                                            <h3><a href="{{route('product-details',['id'=>$home_category_two_product->id])}}">{{$home_category_two_product->name}}</a></h3>
                                        </div>
                                        <div class="product_rating">
                                            <ul>
                                                <li><a href="#"><i class="zmdi zmdi-star-outline"></i></a></li>
                                        ...
                                        <div class="action_links">
                                            <ul>
                                                <li class="wishlist"><a href="wishlist.html" title="Add to Wishlist"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
                                                <li class="add_to_cart"><a href="{{route('cart.direct-add-to-cart',['id'=>$home_category_two_product->id])}}" title="add to cart"><i class="zmdi zmdi-shopping-cart-plus"></i> add to cart</a></li>
                                                <li class="compare"><a href="#" title="compare"><i class="zmdi zmdi-swap"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
