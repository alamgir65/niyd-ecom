            ...
            <div class="row">
                <div class="col-lg-3 col-md-12">
                    ...
                    <aside class="sidebar_widget">
                        <div class="shop_sidebar_banner mb-50">
                            <a href="#"><img src="{{asset('/')}}website/img/bg/banner16.jpg" alt=""></a>
                        </div>
                            ...
                            <div class="recent_product_container">
                                <div class="recent_product_list">
                                    <div class="recent_product_thumb">
                                        <a href="product-details.html"><img src="{{asset('/')}}website/img/s-product/product.jpg" alt=""></a>
                                    </div>
                                ...
                                <div class="recent_product_list">
                                    <div class="recent_product_thumb">
                                        <a href="product-details.html"><img src="{{asset('/')}}website/img/s-product/product2.jpg" alt=""></a>
                                    </div>
                                    <div class="recent_product_content">
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="shop_banner">
                        <img src="{{asset('/')}}website/img/bg/banner29.jpg" alt="">
                    </div>
                    ...
                    <div class="row no-gutters shop_wrapper">
                        ...
                        <div class="col-lg-4 col-md-4 col-12 ">
                            <div class="single_product">
                                <div class="product_thumb">
                                    <a href="product-details.html"><img src="{{asset('/')}}website/img/product/product29.jpg" alt=""></a>
                                    <div class="label_product">
                                        <span class="label_sale">sale</span>
                                    </div>
                                    <div class="quick_button">
