                            ...
                            <div class="mini_cart">
                                ...
                                <div class="cart_item">
                                    ...
                                    <div class="cart_remove">
                                        <a href="{{route('cart.remove',['rowId'=>$item->rowId])}}"><i class="ion-android-close"></i></a>
                                    </div>
                                </div>
                                @endforeach
                ...
                <div class="Offcanvas_menu_wrapper">
                    ...
                    <div class="mini_cart_wrapper">
                        ...
                        <div class="mini_cart">
                            <div class="cart_item">
                                <div class="cart_img">
                                    <a href="#"><img src="{{asset('/')}}website/img/s-product/product.jpg" alt=""></a>
                                </div>
                                <div class="cart_info">
                            ...
                            <div class="cart_item">
                                <div class="cart_img">
                                    <a href="#"><img src="{{asset('/')}}website/img/s-product/product2.jpg" alt=""></a>
                                </div>
                                <div class="cart_info">
                        ...
                        <div class="Latest_Posts_wrapper">
                            <div class="single_Latest_Posts">
                                <div class="Latest_Posts_thumb">
                                    <a href="blog-details.html"><img src="{{asset('/')}}website/img/category/post1.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="single_Latest_Posts">
                                <div class="Latest_Posts_thumb">
                                    <a href="blog-details.html"><img src="{{asset('/')}}website/img/category/post2.jpg" alt=""></a>
                                </div>
                                <div class="Latest_Posts_content">
                            ...
                            <div class="single_Latest_Posts">
                                <div class="Latest_Posts_thumb">
                                    <a href="blog-details.html"><img src="{{asset('/')}}website/img/category/post3.jpg" alt=""></a>
                                </div>
                                <div class="Latest_Posts_content">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-5">
                    <div class="footer_payment text-right">
                        <p><img src="{{asset('/')}}website/img/icon/payment.png" alt=""></p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="modal_tab">
                                <div class="tab-content product-details-large">
                                    <div class="tab-pane fade show active" id="tab1" role="tabpanel" >
                                        <div class="modal_tab_img">
                                            <a href="#"><img src="{{asset('/')}}website/img/product/product37.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="tab2" role="tabpanel">
                                        <div class="modal_tab_img">
                                            <a href="#"><img src="{{asset('/')}}website/img/product/product24.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="tab3" role="tabpanel">
                                        <div class="modal_tab_img">
                                            <a href="#"><img src="{{asset('/')}}website/img/product/product25.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="tab4" role="tabpanel">
                                        <div class="modal_tab_img">
                                            <a href="#"><img src="{{asset('/')}}website/img/product/product22.jpg" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal_tab_button">
                                    <ul class="nav product_navactive owl-carousel" role="tablist">
                                        <li >
                                            <a class="nav-link active" data-bs-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="false"><img src="{{asset('/')}}website/img/product/productbig1.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a class="nav-link" data-bs-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false"><img src="{{asset('/')}}website/img/product/productbig2.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a class="nav-link button_three" data-bs-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false"><img src="{{asset('/')}}website/img/product/productbig4.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a class="nav-link" data-bs-toggle="tab" href="#tab4" role="tab" aria-controls="tab4" aria-selected="false"><img src="{{asset('/')}}website/img/product/productbig5.jpg" alt=""></a>
                                        </li>
