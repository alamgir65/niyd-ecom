            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('product.update',['id'=>$product->id])}}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="number" value="{{$product->regular_price}}" class="form-control" placeholder="Regular Price" name="regular_price">
                                <input type="number" value="{{$product->selling_price}}" class="form-control" placeholder="Selling Price" name="selling_price">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10 ">
                            <label><input type="radio" name="status" value="0" {{$product->status==0?'checked':''}}/>Published</label>
                            <label><input type="radio" name="status" value="1" {{$product->status==1?'checked':''}}/>Unpublished</label>
                        </div>
                    </div>
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            ...
                            <img src="{{asset($product->image)}}" height="50" alt="img">
                        </div>
                    </div>
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div>
                                @foreach($product->otherImage as $image)
                                    <img src="{{asset($image->image)}}" height="50" alt="img">
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{$product->meta_title}}"  placeholder="Meta Title" name="meta_title">
                        </div>
                    </div>
                    <div class="row mb-4">
