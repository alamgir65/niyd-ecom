                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="{{asset('/')}}website/img/product/productbig1.jpg" data-zoom-image="{{asset('/')}}website/img/product/productbig1.jpg" alt="big-1">
                            </a>
                        </div>
                        <div class="single-zoom-thumb">
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="{{asset('/')}}website/img/product/productbig2.jpg" data-zoom-image="{{asset('/')}}website/img/product/productbig2.jpg">
                                        <img src="{{asset('/')}}website/img/product/productbig2.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="{{asset('/')}}website/img/product/productbig3.jpg" data-zoom-image="{{asset('/')}}website/img/product/productbig3.jpg">
                                        <img src="{{asset('/')}}website/img/product/productbig3.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="{{asset('/')}}website/img/product/productbig4.jpg" data-zoom-image="{{asset('/')}}website/img/product/productbig4.jpg">
                                        <img src="{{asset('/')}}website/img/product/productbig4.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="{{asset('/')}}website/img/product/productbig5.jpg" data-zoom-image="{{asset('/')}}website/img/product/productbig5.jpg">
                                        <img src="{{asset('/')}}website/img/product/productbig5.jpg" alt="zo-th-1"/>
                                    </a>
